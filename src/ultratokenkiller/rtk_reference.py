...
CASES = (
    ...
    {
        "id": "gh-pr-list-success",
        "fixture": "hosting_gh_pr_list_raw.json",
        "program": "gh",
        "argv": ["gh", "pr", "list"],
        "kind": "hosting-list",
        "exit_code": 0,
        "required": ["#42", "[open]", "Preserve migration guard", "dev"],
    },
    {
        "id": "gh-pr-list-failure",
        "fixture": "hosting_auth_failure_raw.txt",
        "program": "gh",
        "argv": ["gh", "pr", "list"],
        "kind": "hosting-list",
        "exit_code": 1,
        "fixture_stderr": True,
        "required": ["authentication required", "do not retry"],
    },
    {
        "id": "gh-pr-list-user-json",
        "fixture": "hosting_unknown_raw.json",
        "program": "gh",
        "argv": ["gh", "pr", "list", "--json", "customField"],
        "kind": "passthrough",
        "exit_code": 0,
        "expect_passthrough": True,
        "required": ["customField", "must remain exact"],
    },
    {
        "id": "glab-mr-list-success",
        "fixture": "hosting_glab_mr_list_raw.json",
        "program": "glab",
        "argv": ["glab", "mr", "list"],
        "kind": "hosting-list",
        "exit_code": 0,
        "required": ["!7", "[open]", "Keep tenant check", "reviewer"],
    },
    {
        "id": "glab-mr-list-failure",
        "fixture": "hosting_auth_failure_raw.txt",
        "program": "glab",
        "argv": ["glab", "mr", "list"],
        "kind": "hosting-list",
    ...
    {
        "id": "glab-mr-list-user-json",
        "fixture": "hosting_unknown_raw.json",
        "program": "glab",
        "argv": ["glab", "mr", "list", "-F", "json"],
        "kind": "passthrough",
        "exit_code": 0,
        "expect_passthrough": True,
        "required": ["customField", "must remain exact"],
    ...
    {
        "id": "gt-log-success",
        "fixture": "hosting_gt_log_raw.txt",
        "program": "gt",
        "argv": ["gt", "log"],
        "kind": "gt-log",
        "exit_code": 0,
        "required": ["abc1234", "feat/auth", "preserve auth guard"],
    },
    {
        "id": "gt-sync-failure",
        "fixture": "hosting_auth_failure_raw.txt",
    ...
    {
        "id": "gt-submit-success",
        "fixture": "hosting_gt_submit_raw.txt",
        "program": "gt",
        "argv": ["gt", "submit"],
        "kind": "gt-submit",
        "exit_code": 0,
        "required": ["feat/auth", "#42", "https://example.test/pull/42"],
    },
    {
        "id": "gt-submit-failure",
        "fixture": "hosting_auth_failure_raw.txt",
        "program": "gt",
        "argv": ["gt", "submit"],
        "kind": "gt-submit",
    ...
    {
        "id": "gt-sync-success",
        "fixture": "hosting_gt_sync_raw.txt",
        "program": "gt",
        "argv": ["gt", "sync"],
        "kind": "gt-sync",
        "exit_code": 0,
        "required": ["feat/merged", "fix/old"],
    },
    {
        "id": "gt-restack-success",
        "fixture": "hosting_gt_restack_raw.txt",
        "program": "gt",
        "argv": ["gt", "restack"],
        "kind": "gt-restack",
        "exit_code": 0,
        "required": ["restacked", "3 branches"],
    },
    {
        "id": "gt-restack-failure",
        "fixture": "hosting_auth_failure_raw.txt",
        "program": "gt",
        "argv": ["gt", "restack"],
        "kind": "gt-restack",
    ...
    {
        "id": "gt-create-success",
        "fixture": "hosting_gt_create_raw.txt",
        "program": "gt",
        "argv": ["gt", "create"],
        "kind": "gt-create",
        "exit_code": 0,
        "required": ["created", "feat/new-feature"],
    },
    {
        "id": "gt-create-failure",
        "fixture": "hosting_auth_failure_raw.txt",
        "program": "gt",
        "argv": ["gt", "create"],
        "kind": "gt-create",
        ...
        reports.append(
            {
                ...
                "expected_passthrough": bool(case.get("expect_passthrough")),
                "upstream_matches_raw": upstream.strip() == raw.strip(),
                "utk_matches_raw": native.strip() == raw.strip(),
            }
        )
    return {
        "schema_version": 1,
